...
impl<const LIMBS: usize> Int<LIMBS> {
    ...
    pub fn binxgcd(&self, rhs: &Self) -> BinXgcdOutput<LIMBS> {
...
impl<const LIMBS: usize> Odd<Int<LIMBS>> {
    ...
    ///
    /// Given `(self, rhs)`, computes `(g, x, y)` s.t. `self * x + rhs * y = g = gcd(self, rhs)`.
    pub fn binxgcd(&self, rhs: &NonZero<Int<LIMBS>>) -> BinXgcdOutput<LIMBS> {
...
mod test {
    ...
    mod test_nonzero_int_binxgcd {
        ...
        #[cfg(feature = "rand_core")]
        use crate::{int::bingcd::test::make_rng, Random};
    ...
    mod test_odd_int_binxgcd {
        use crate::int::bingcd::test::binxgcd_test;
        use crate::{
            ConcatMixed, Int, Uint, U1024, U128, U192, U2048, U256, U384, U4096, U512, U64, U768,
            U8192,
        };
