...
impl<const LIMBS: usize> Int<LIMBS> {
    ...
    #[inline]
    pub(crate) const fn conditional_wrapping_neg(&self, negate: CtChoice) -> Int<LIMBS> {
        Self(self.0.conditional_wrapping_neg(negate))
    }
...
mod tests {
    ...
    fn negate_if_unsafe() {
        ...
        let do_negate = CtChoice::TRUE;
        assert_eq!(I128::MIN.conditional_wrapping_neg(do_negate), I128::MIN);
        assert_eq!(I128::MINUS_ONE.conditional_wrapping_neg(do_negate), I128::ONE);
        assert_eq!(I128::ZERO.conditional_wrapping_neg(do_negate), I128::ZERO);
        assert_eq!(I128::ONE.conditional_wrapping_neg(do_negate), I128::MINUS_ONE);
        assert_eq!(I128::MAX.conditional_wrapping_neg(do_negate), min_plus_one);

        let do_not_negate = CtChoice::FALSE;
        assert_eq!(I128::MIN.conditional_wrapping_neg(do_not_negate), I128::MIN);
        assert_eq!(
            I128::MINUS_ONE.conditional_wrapping_neg(do_not_negate),
            I128::MINUS_ONE
        );
        assert_eq!(I128::ZERO.conditional_wrapping_neg(do_not_negate), I128::ZERO);
        assert_eq!(I128::ONE.conditional_wrapping_neg(do_not_negate), I128::ONE);
        assert_eq!(I128::MAX.conditional_wrapping_neg(do_not_negate), I128::MAX);
    }
