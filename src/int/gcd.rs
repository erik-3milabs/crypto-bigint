...
#[cfg(test)]
mod tests {
    use crate::{ConstChoice, Int, I1024, I128, U1024, U128};
    ...
    fn gcd_large() {
        ...
        let y = I1024::from_be_hex("").checked_neg().unwrap();
        ...
        // divide out factors
        let x_on_gcd = x
            .checked_div(&Int::new_from_abs_sign(res, ConstChoice::FALSE).unwrap())
            .unwrap();
        let y_on_gcd = y
            .checked_div(&Int::new_from_abs_sign(res, ConstChoice::FALSE).unwrap())
            .unwrap();
